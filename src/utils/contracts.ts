...
export const COMPANY_REGISTRY_ADDRESS = (import.meta as any).env.VITE_COMPANY_REGISTRY_ADDRESS || ''
export const WORKER_REGISTRY_ADDRESS = (import.meta as any).env.VITE_WORKER_REGISTRY_ADDRESS || ''
export const PAYROLL_CONTRACT_ADDRESS = (import.meta as any).env.VITE_PAYROLL_CONTRACT_ADDRESS || ''
